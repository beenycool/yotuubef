...
class SpeedOptimizer:
        ...
        try:
            ...
            try:
                ...
                if gpus:
                    gpu_available = True
                    gpu_memory_gb = max(
                        gpu.memoryTotal / 1024 for gpu in gpus
                    )  # Convert MB to GB
                ...
                try:
                    ...
                    logger.debug("GPU capability detection failed: %s", exc)
            ...
            try:
                ...
                logger.debug("QuickSync detection failed: %s", exc)
            ...
            self.logger.info(
                f"Detected system: {cpu_cores} cores, {ram_gb:.1f}GB RAM, "
    ...
    def get_optimal_settings(
        self, target_quality: str = "standard", target_speed: str = "aggressive"
    ) -> Dict[str, Any]:
            ...
            settings.update(
                {
                    ...
                    "ffmpeg_params": [
                        ...
                        "vbr",
                        "-rc-lookahead",
                        "10",  # Minimal lookahead
                        "-surfaces",
                        "32",  # Reduced surfaces for speed
                        "-bf",
                        "2",  # Fewer B-frames
                        "-gpu",
                        "0",
            ...
            settings.update(
                {
                    ...
                    "ffmpeg_params": [
                        ...
                        "-x264-params",
                        "ref=1:bframes=0:subme=1:me=dia:no-cabac=1:trellis=0:weightp=0",
                    ],
                }
            )
        elif speed == "balanced":
            settings.update(
                {
                    ...
                    "ffmpeg_params": [
                        ...
                        "fastdecode",
                        "-x264-params",
                        "ref=2:bframes=2:subme=4:me=hex:trellis=1",
                    ],
                }
            )
        else:  # conservative
    ...
    def _get_speed_params(self, speed: str) -> Dict[str, Any]:
        ...
        if speed == "aggressive":
            ...
            params.update(
                {"temp_audiofile": None, "remove_temp": True, "audio_bitrate": "192k"}
            )
